  ...
  return (
    <div>
      <div className="bg-zinc-900 w-full min-h-screen">
        <div className="flex flex-col justify-center items-center py-10 sm:py-20 space-y-10 sm:space-y-30">
          <h1 className="flex text-3xl sm:text-4xl">Our Services</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-10 sm:space-y-0 sm:space-x-10 animate__animated animate__fadeInTopLeft ">
          <div className="bg-white rounded-3xl w-full  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-100 duration-300 sm:w-[30rem] h-[30rem]">
            <div className="flex  justify-center flex-col text-orange-400 items-center ">
              ...
              <h2 className="text-lg  text-zinc-900 px-6 sm:px-20">
              ...
              <button className="flex w-[60%] h-[40%] items-center justify-between bg-orange-500 hover:bg-orange-700 text-white font-semibold  sm:mt-20 text-2xl py-[4%] px-[6%] rounded-full animate__animated animate__fadeInUp">
          ...
          <div className="bg-white rounded-3xl w-full  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-100 duration-300 sm:w-[30rem] h-[30rem]">
            <div className="flex justify-center flex-col text-orange-400 items-center">
              ...
              <button className="flex mb-8 w-[60%] h-[40%] items-center justify-between bg-orange-500 hover:bg-orange-700 text-white font-semibold mt-10 sm:mt-20 text-2xl py-[4%] px-[6%] rounded-full animate__animated animate__fadeInUp">
                <span className="flex-grow text-zinc-800 ">Recruit now</span>
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-10 sm:space-y-0 sm:space-x-10 py-10 animate__animated animate__fadeInBottomRight">
          ...
          <div className="bg-white rounded-3xl w-full   transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-100 duration-300 sm:w-[30rem] h-[30rem]">
            <div className="flex justify-center flex-col text-orange-400 items-center">
              ...
              <button className="flex  w-[60%] h-[40%] mb-6 items-center justify-between bg-orange-500 hover:bg-orange-700 text-white font-semibold  sm:mt-20 text-2xl py-[4%] px-[6%] rounded-full animate__animated animate__fadeInUp">
                <span className="flex-grow text-zinc-800">Recruit now</span>
              </button>
